...
public class FavoriteDao {
    ...
    */
/*Get favorite item ids for the given user. Used for dedup and category
    the return value is the set of favorite items in three types
    * *//*
...
/*Get favorite items for the given user. The returned map includes three entries like {"Video": [item1, item2, item3],
     ...
     the return value is the <Type, gameList> pair, with duplicates
      *//*
