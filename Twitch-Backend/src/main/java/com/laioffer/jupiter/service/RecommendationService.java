...
/*Return a list of Item objects for the given type. Types are one of [Stream, Video, Clip].
     ...
     return the toplist as default given a certain type
      *//*
    ...
    */
/*recommend default for three types*//*
...
/*Return a list of Item objects for the given type. Types are one of [Stream, Video, Clip].
    ...
    E.g., if a user favorited some videos about game "Just Chatting", then it will return some other videos about
    the same game. Sorting the most like games, cutting the first [defaut, three here] games, dedup in this function.
    *//*
