...
//this annotation defines the class as a controller
@Controller
public class GameController {

    private GameService gameService;

    // autowired annotation is for injection of dependency, and we can use this specific way of constructor
    @Autowired
    public GameController(GameService gameService){
        this.gameService = gameService;
    }

    // RequestMapping annotation is for defining our own method name, the value is the path, the method is the method
    // the in the getGame method parameter, the RequestParam annotation is to find the "value" of the key
    // "game_name" after "?" and assign it to gameName.
    @RequestMapping(value = "/game", method = RequestMethod.GET)
    public void getGame(@RequestParam(value = "game_name", required = false) String gameName, HttpServletResponse response) throws IOException, ServletException {
